...
renderer = GPURenderer(ctx, 16, bm_slot=0, queue=0)
renderer2 = GPURenderer(ctx2, 16, bm_slot=1, queue=1)
...
work2 = renderer2.submit(f2.cmdbuf)
workb = renderer.submit(f.cmdbuf)
work2b = renderer2.submit(f2.cmdbuf)
